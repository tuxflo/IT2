...
public class RTPpacket{
    ...
    //--------------------------
    public RTPpacket(int PType, int Framenb, int Time, byte[] data, int data_length, int k){
    ...
    public RTPpacket(byte[] packet, int packet_size)
    {
        ...
        if (packet_size >= HEADER_SIZE)
        {
            ...
            int ret = 0;
            ret <<= 8;
            ret |= (int) header[8] & 0xFF;
            ret |= (int) header[9] & 0xFF;
            ret |= (int) header[10] & 0xFF;
            ret |= (int) header[11] & 0xFF;
            Ssrc = ret;
        }
    }

    //empty ctor for allocating
    public RTPpacket(){
